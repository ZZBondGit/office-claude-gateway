...
def build_models_response(provider: ProviderConfig) -> Dict[str, Any]:
    ...
    ordered_ids = [
        (_non_empty(provider.alias_opus_versioned, "claude-opus-4-7"), "Claude Opus 4.7"),
        (_non_empty(provider.alias_sonnet_versioned, "claude-sonnet-5"), "Claude Sonnet 5"),
        (_non_empty(provider.alias_opus, "opus"), "Claude Opus 4.7"),
        (_non_empty(provider.alias_sonnet, "sonnet"), "Claude Sonnet 5"),
    ]
